...
import { signoutSuccess,deleteUserStart,deleteUserFailure,deleteUserSuccess,updateStart,updateFailure,upadateSuccess } from '../redux/user/userSlice';
...
export default function DashProfile() {
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col overflow-hidden rounded-full shadow-md cursor-pointer'>
           ...
           filePickerRef.current.click()}>
            ...
            ${imageFileUploadingProgress && imageFileUploadingProgress<100 } 'opacity-60%`}></img>
            </div>
